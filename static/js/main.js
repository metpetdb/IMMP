...
document.getElementById("help").addEventListener("click",function(){
    alert("To add a mapping, click anywhere on the image, then click the data row you wish to map to that location. A red X will appear which allows you to delete mappings you've created. Click 'Save' in the bottom right to save your map once you've finished.")
});
