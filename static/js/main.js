...
document.getElementById("help").addEventListener("click",function(){
    alert("To add a mapping, click anywhere on the image, then click the data row you wish to map to that location. If you click the 'Delete Mappings' button, a red X will appear next to each mapped row which allows you to delete mappings you've created. Click 'Save' in the bottom right to save your map once you've finished.")
});
